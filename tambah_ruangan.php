...
<html lang="en">
    ...
    <div id="layoutSidenav_content">
        ...
        <div class="content">
                    ...
                    <div class="card mb-4">
                        <form method="post" action="proses_tambah_ruangan.php">
                            <div class="card-body">
                                <label for="exampleInputEmail1"><p>Ruangan</p></label><br>
                                <input type="text" class="form-control" name="ruangan" placeholder="Masukan nama ruangan">
                            </div>
