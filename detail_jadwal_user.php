        ...
        <div class="content">
                    <div class="col-md-12 row">
                        ...
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="menu_jadwal_user.php">Jadwal</a></li>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form action="proses.php" method="post" id="form_id_<?php echo $j.'_'.$data_jam['id_jam']; ?>">
                                            ...
                                            <select name="id_pelajaran" disabled name="#" style="width: 150px; class="form-control" data-toggle="tooltip" data-placement="top" title="<?php echo $data_jadwal['pelajaran']; ?>"
                                        ...
                                        <form action="proses.php" method="post" id="form_id1_<?php echo $j.'_'.$data_jam['id_jam']; ?>">
                                            ...
                                            <div class="">
                                            <select name="id_ruangan" disabled name="#" style="width: 150px; class="form-control" data-toggle="tooltip" data-placement="top" title="<?php echo $data_jadwal['ruangan']; ?>"
                                        ...
                                        <form action="proses.php" method="post" id="form_id2_<?php echo $j.'_'.$data_jam['id_jam']; ?>">
                                            ...
                                            ?>
                                            <div class="">
                                            <select name="id_guru" disabled name="#" style="width: 150px; class="form-control" data-toggle="tooltip" data-placement="top" title="<?php echo $guru_tooltip['nama']; ?>"
